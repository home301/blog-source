---
description: "home301 — AI, 개발, 게임, 그 외 소소한 것들을 담는 블로그. 알고 있던 걸 정리하거나, 직접 삽질하고 해결해 나가는 과정을 기록한다."
hide:
  - navigation
  - toc
---
...
home301은 AI, 개발, 게임, 그 외 소소한 것들을 담는 블로그다. 알고 있던 걸 정리하거나, 직접 삽질하고 해결해 나가는 과정을 기록한다.
...
[:material-arrow-right: 전체 글 보기](blog/){ .md-button }
